    ...
    <div class="glass-card !items-start !text-left !cursor-default !rounded-2xl !p-14 gap-12 animate-fade-up delay-1 w-full">
      ...
      <div class="grid grid-cols-2 gap-10 w-full">
        ...
        <div class="flex items-start gap-5">
          ...
          <div>
            ...
            <p class="text-base font-semibold text-gray-900 mt-2">{{$worker->experience_years}} ans</p>
          </div>
        </div>
        ...
        <div class="flex items-start gap-5">
          ...
          <div>
            ...
            <p class="text-base font-semibold text-gray-900 mt-2">{{$worker->ville}}</p>
          </div>
        </div>
        ...
        <div class="flex items-start gap-5">
          ...
          <div>
            ...
            <p class="text-base font-semibold text-gray-900 mt-2">{{$worker->adress}}</p>
          </div>
        </div>
      ...
      <div class="w-full">
        ...
        <div class="flex flex-wrap gap-3">
          ...
          <a href="{{ $certificateUrl }}" class="flex items-center gap-2 px-3 py-2 rounded-xl border border-gray-200 bg-white text-xs font-medium text-gray-700 hover:border-gray-400 hover:text-gray-900 transition-all">
          ...
          @if($role == 'admin')
          <a href="{{$cin}}" class="flex items-center gap-2 px-3 py-2 rounded-xl border border-gray-200 bg-white text-xs font-medium text-gray-700 hover:border-gray-400 hover:text-gray-900 transition-all">
            <svg width="13" height="13" viewBox="0 0 16 16" fill="none">
              <path d="M4 2h6l4 4v8a1 1 0 01-1 1H4a1 1 0 01-1-1V3a1 1 0 011-1z" stroke="#9ca3af" stroke-width="1.3"/>
              <path d="M9 2v4h4" stroke="#9ca3af" stroke-width="1.3" stroke-linecap="round"/>
            </svg>
          ...
          <a href="{{$deplomaUrl}}" class="flex items-center gap-2 px-3 py-2 rounded-xl border border-gray-200 bg-white text-xs font-medium text-gray-700 hover:border-gray-400 hover:text-gray-900 transition-all">
            <svg width="13" height="13" viewBox="0 0 16 16" fill="none">
              <path d="M4 2h6l4 4v8a1 1 0 01-1 1H4a1 1 0 01-1-1V3a1 1 0 011-1z" stroke="#9ca3af" stroke-width="1.3"/>
              <path d="M9 2v4h4" stroke="#9ca3af" stroke-width="1.3" stroke-linecap="round"/>
            </svg>
