  ...
  <main class="flex-1 max-w-6xl mx-auto w-full px-6 py-12">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10 animate-fade-up">
      <div>
        ...
        <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Bonjour, <?php echo e($user->name); ?> 👋</h1>
      </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\N-A-S\resources\views/client/home.blade.php ENDPATH**/ ?>