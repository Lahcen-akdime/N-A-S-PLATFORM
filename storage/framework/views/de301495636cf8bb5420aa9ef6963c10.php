...
<main class="flex-1 max-w-7xl mx-auto w-full px-6 py-12 flex flex-col gap-8">
    ...
    <div class="animate-fade-up delay-1 flex items-center gap-2 flex-wrap">
        ...
        <a href="/filter/all" class="filter-btn px-4 py-2 rounded-full text-sm font-semibold bg-gray-900 text-white transition-all">Tous <span class="ml-1 text-xs opacity-60"><?php echo e($messages->count()); ?></span></a>  
        <a href="/filter/authenticated" class="filter-btn px-4 py-2 rounded-full text-sm font-semibold  border border-gray-200  bg-gray-900 text-white hover:border-gray-400 transition-all">Authentifiés <span class="ml-1 text-xs opacity-60"><?php echo e($authenticated); ?></span></a>
        <a href="/filter/anonymos" class="filter-btn px-4 py-2 rounded-full text-sm font-semibold border border-gray-200  bg-gray-900 text-white hover:border-gray-400 transition-all">Anonymes <span class="ml-1 text-xs opacity-60"><?php echo e($notAuthenticated); ?></span></a>
    </div>
 ...
 <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="msg-row grid grid-cols-12 gap-4 px-6 py-5 items-start hover:bg-gray-50/60 transition-colors" data-read="false" data-auth="true">
          ...
          <div class="col-span-1 flex justify-end">
            <form action="<?php echo e(route('contact.show',$message)); ?>" method="get">
              <?php echo csrf_field(); ?>
