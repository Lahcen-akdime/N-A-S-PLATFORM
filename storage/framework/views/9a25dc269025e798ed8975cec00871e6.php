...
<main class="flex-1 max-w-6xl mx-auto w-full px-6 py-16 flex flex-col gap-14">
  ...
  <h2 style="color:green ; border:solid 1px green;border-radius:5px;padding:10px;text-align:center"><?php echo e(session('message')); ?></h2>
  <?php endif; ?>
  <!-- Title -->
          ...
          <div id="form-view" class="glass-card !items-start !text-left !cursor-default !rounded-2xl !p-10 gap-6 w-full">
            ...
            <?php if($errors->any()): ?>
                <ul>
                  ...
                  <li style="color:red;border:solid 1px red;border-radius:5px;padding:10px;text-align:center"><?php echo e($error); ?></li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\N-A-S\resources\views/Contact.blade.php ENDPATH**/ ?>