...
<?php endif; ?>
        ...
        <p class="text-center text-xs text-gray-400">
          ...
          <a href="<?php echo e(route('login.index')); ?>" class="text-gray-700 font-medium hover:text-gray-900 transition-colors">Se connecter</a>
        </p>
...
<?php echo $__env->make('Layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\N-A-S\resources\views/Auth/client_register.blade.php ENDPATH**/ ?>