...
<!-- MAIN -->
    ...
    <div id="works-list" class="flex flex-col divide-y divide-gray-100">
        ...
        <div class="work-row grid grid-cols-12 gap-4 px-6 py-5 items-center hover:bg-gray-50/60 transition-colors">
            ...
            <div class="col-span-3 flex items-center gap-3">
                <span class="text-sm font-semibold text-gray-900"><?php echo e($work->name); ?></span>
            </div>
            <span></span>
            <span class="col-span-2 text-sm font-semibold text-gray-700"><?php echo e($work->worker()->count()); ?></span>
            <span></span>
          <div class="col-span-2 flex items-center justify-end gap-2">
            <button onclick="updateModal(this.dataset.work)" data-work="<?php echo e($work); ?>" class="w-8 h-8 rounded-xl border border-gray-200 bg-white flex items-center justify-center hover:border-gray-400 transition-all">
  ...
  <!-- update modal -->
  <form id="updateform" action="<?php echo e(route('work.update',' ')); ?>" method="post">
      <?php echo csrf_field(); ?> 
  ...
  <!-- ADD MODAL -->
   <form action="<?php echo e(route('work.store')); ?>" method="post">
    <?php echo csrf_field(); ?> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\N-A-S\resources\views/Admin/works.blade.php ENDPATH**/ ?>