 <section class="max-w-6xl mx-auto px-6 pb-20">
      <div class="bg-gray-950 rounded-3xl px-10 py-14 text-center text-white space-y-6">
        ...
        <div class="flex items-center justify-center gap-3 flex-wrap">
          <a href="//shoose" class="bg-white text-gray-900 px-6 py-3 rounded-full text-sm font-bold hover:bg-gray-100 transition-colors">
            Try App For Free
          </a>
    ...
    </section><?php /**PATH C:\laragon\www\N-A-S\resources\views/components/cta.blade.php ENDPATH**/ ?>